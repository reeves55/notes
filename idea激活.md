# Jetbrain IDEA 2019.2激活(有效期至2089年)

## 1. 下载crack jar包

下载地址：https://pan.baidu.com/s/1ubtv7e2eRr8IYGV37N_Rxw

密码：2clc



## 2. 将crack jar放到一个没有中文的路径下面

## 3. 设置idea vm options

以evaluate的方式打开idea，然后点击 Help -> Edit Custom VM Options...

在文件末尾添加上：

```shell
-javaagent: /the_path_to_crack_jar
```
...
参考网址：https://www.xiaomiqiu.com/article/78